...
<head>
   ...
   <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-85350869-6"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-85350869-6');
    </script>
    ...
    <title>BBlossom Butik E-Commerce Software</title>
    ...
    <meta name="author" content="Jeff Simons Decena and reformatted by FEDRUS">
