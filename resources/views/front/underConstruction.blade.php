...
<body id="top">
   ...
   <header>
   	...
   	<div class="row">
   		<div class="logo">
	         <a href="#!">BBlossom Butik</a>
	      </div> 

			<div class="social-links">
			   <ul>
					<li><a href="https://www.facebook.com/BBlossomButik/"><i class="fa fa-facebook"></i></a></li>
		   		...
		   		<div class="col-twelve">
		   			...
		   			<div id="counter">
			  			...
			  			<div class="bottom-text">
				  			...
				  			<p>
							BBlossomButik.com is a modern and stylish website designed to present our customers with online service and delivery of BBlossom products... Please, bear with us while our tireless developement team works to get the best to service you! 
				  			</p>			  				
			  			</div>			  						  			   			
					   ...
					   <div class="tab-entry">
					   	...
					   	<div class="row tab-entry-intro">
					   		<div class="col-twelve with-bottom-line">
					   			...
					   			<h1>Get to know us and make a purchase by calling +2347038625309</h1>

					   			<p class="lead">Please, contact our sales represnetative on +2347038625309</p>
   ...
   <footer>
   	...
   	<div class="social-wrap">
   		<div class="row">
	         ...
	         <ul class="footer-social-list">
	            <li><a href="https://www.facebook.com/BBlossomButik/">
   	...
   	<div class="footer-bottom">
   		...
   		<div class="copyright">
		     	<span>© BBlossom Butik 2018.</span> 
		     	<span>Design by <a href="#!">Fedrus Consulting</a></span>		         	
		   </div>		   
